...
namespace CandidatesAndEmployees
{
    ...
    {
        public static int minDesiredSalary = 500;
        public static int maxDesiredSalary = 4000;
        ...
        {
            Console.WriteLine(
                $"Hello, I am {Name} {Surname} I want to be a {DesiredPosition} ({PositionDescription}) with a salary" +
                "from {DesiredSalary}");
        }
