...
namespace CandidatesAndEmployees
{
    public class EmployeeReportGenerator : IReportGenerator<Employee>
    {
        public void GenerateReport(List<Employee> employees)
        {
            ...
            Console.WriteLine("| {0, 37} | {1, 35} | {2, 25} | {3, 6} |", "Employee Id", "Company Name",
                "Employee Full Name", "Salary");
            foreach (var employee in employees)
            {
                Console.WriteLine("| {0, 37} | {1, 35} | {2, 25} | {3, 6} |", employee.Id, employee.Company.Name,
